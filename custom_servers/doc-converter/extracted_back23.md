...
The system uptime has improved significantly. Below is the breakdown by
...
|Asia Pacifc|99.90%|200ms|Critical|
...
```python def calculate_metrics(data): """Calculates performance metrics"""
